    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-theme-bg px-4">
        <div className="max-w-md w-full text-center space-y-4">
          <div className="bg-theme-primary/10 border border-theme-primary/30 text-theme-text px-4 py-3 rounded-lg">
    ...
    <div className="min-h-screen flex items-center justify-center bg-theme-bg px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-theme-muted">{t("auth.signup.subtitle")}</p>
        </div>
